...
const AllSellers = () => {
    const { data: sellers = [], refetch } = useQuery({
        queryKey: ['sellers'],
        queryFn: async () => {
            const res = await fetch('https://tukitakibyrhidy.web.app/users/sellers');
    ...
    /* const handleVerifySeller = email => {
          console.log(email)
         fetch(`https://tukitakibyrhidy.web.app/users/sellers/verify/${email}`, {
             method: 'PUT', 
             headers: {
    ...
    const handleVerifySeller = (id) => {
        try {
            axios.put(`https://tukitakibyrhidy.web.app/users/sellers/verify/${id}`, {
                verified: 'yes'
            })
                .then(res => {
                    console.log(res)
    ...
    const handleUnverifySeller = id => {
        // fetch(`https://tukitakibyrhidy.web.app/users/sellers/unverify/${email}`, {
        //     method: 'PUT', 
        //     headers: {
        //         authorization: `bearer ${localStorage.getItem('accessToken')}`
        //     },
        ...
        // })
        try {
            axios.put(`https://tukitakibyrhidy.web.app/users/sellers/unverify/${id}`, {
                verified: 'no'
            })
                .then(res => {
                    console.log(res)
    ...
    const handleDeleteSeller = id => {
        fetch(`https://tukitakibyrhidy.web.app/users/sellers/${id}`, {
            method: 'Delete',
            // headers: {
            //     authorization: `bearer ${localStorage.getItem('accessToken')}`
            // }
